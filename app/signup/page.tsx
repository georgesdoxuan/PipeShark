    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-sky-950 to-black flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div className="bg-black/60 border border-sky-900 rounded-xl p-6">
            <h2 className="text-xl font-bold text-white mb-2">Check your email</h2>
            <p className="text-sky-200/90 mb-4">
              We&apos;ve sent you a confirmation link. Click it to verify your account, then sign in.
            </p>
            <Link
              href="/login"
              className="inline-flex items-center gap-2 px-4 py-2 bg-sky-700 hover:bg-sky-600 text-white font-semibold rounded-lg"
            >
              Go to Sign in
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-sky-950 to-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sky-200/90">Create your account</p>
        </div>
        ...
        >
          ...
          <div className="mb-4">
            <label htmlFor="fullName" className="block text-sm font-medium text-sky-200 mb-2">
              Full name
            </label>
            <input
              id="fullName"
          ...
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p className="mt-1 text-xs text-sky-500">Minimum 6 characters</p>
          </div>
